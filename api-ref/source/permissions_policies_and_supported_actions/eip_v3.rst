:original_name: eip_apipermission_0011.html

.. _eip_apipermission_0011:
...
+----------------------------------------------+-------------------------------------------------------------------------+----------------------+
| Adding EIPs to a shared bandwidth in batches | POST /v3/{project_id}/eip/publicips/attach-share-bandwidth              | vpc:publicIps:update |
+----------------------------------------------+-------------------------------------------------------------------------+----------------------+
